      ...
      <div class="paper">
        <div class="paper__inner">
          ...
          <div class="social">
            ...
            <a class="social__card" href="https://www.linkedin.com/in/christerbarregren/" target="_blank" rel="noopener">
    ...
    <img src="/assets/img/logo.png" alt="" class="footer-logo">
      ...
      © <span id="year"></span> Christer Barregren. This is his  <a href="/en/manifesto.php" class="textlink">manifesto</a>.
    </footer>
