<?php
$pageTitle = "Christer Barregren | Blog";
$activeNav = "blog";
include __DIR__ . "/../../partials/header.php";
$postsDir = __DIR__ . "/blogg-poster";
require __DIR__ . "/../../partials/blogg-loader.php";

// Filtrera till engelska inlägg
    ...
    <div class="paper__inner">
        ...
        <div class="blog-single">
          ...
          <div class="blog-single__header">
            ...
            <?php if (!empty($single['tags'])): ?>
              <div class="poem-tags" style="justify-content:center;">
                <span class="poem-tags__label">Tags:</span>
                <?php foreach ($single['tags'] as $tag): ?>
                  <a class="blog-tag" href="/en/blog/?tag=<?php echo urlencode($tag); ?>"><?php echo h($tag); ?></a>
                <?php endforeach; ?>
              </div>
            <?php endif; ?>
          </div>
          ...
          <?php if ($hasGallery): ?>
            <div class="blog-carousel" data-carousel>
              <button class="car-btn car-btn--prev" type="button" data-prev aria-label="Previous bild">‹</button>
              ...
              <button class="car-btn car-btn--next" type="button" data-next aria-label="Next bild">›</button>
          ...
          <div class="blog-single__foot">
            <a class="card__link" href="/en/blog/">← More posts</a>
          </div>
      ...
      <?php else: ?>
        ...
        <header class="intro">
          <h1>Blog</h1>
          <?php if ($activeTag !== ''): ?>
            <p class="subtitle">Tag: <strong><?php echo h($activeTag); ?></strong> &nbsp;·&nbsp; <a class="textlink" href="/en/blog/">Show all</a></p>
          <?php else: ?>
            <p class="subtitle">Notes, drafts and fragments</p>
          <?php endif; ?>
        </header>
          ...
          <div class="reading">
            <?php foreach ($postsForPage as $p): ?>
              ...
              <article class="media-box media-box--blog">
                ...
                <div class="media-box__content">
                    ...
                    <p class="blog-tags">
                      <?php foreach ($p['tags'] as $tag): ?>
                        <a class="blog-tag <?php echo $tag === $activeTag ? 'blog-tag--active' : ''; ?>"
                           href="/en/blog/?tag=<?php echo urlencode($tag); ?>">
                          <?php echo h($tag); ?>
                        </a>
                      <?php endforeach; ?>
                    </p>
                  ...
                  <a class="card__link" href="<?php echo h($postUrl); ?>">Read more</a>
                </div>
            ...
            <?php if ($totalPages > 1): ?>
              <nav class="blog-pager">
                <div>
                  <?php if ($page > 1): ?>
                    <a class="card__link" href="/en/blog/?page=<?php echo $page - 1; ?>">Previous</a>
                  <?php endif; ?>
                </div>
                ...
                <div>
                  <?php if ($page < $totalPages): ?>
                    <a class="card__link" href="/en/blog/?page=<?php echo $page + 1; ?>">Next</a>
                  <?php endif; ?>
                </div>
              </nav>
            <?php endif; ?>
